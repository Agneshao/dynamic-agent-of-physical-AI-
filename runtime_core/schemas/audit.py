...
class AuditRecordType(str, Enum):
    ...
    EMERGENCY_MODE_AUTHORIZATION_APPROVED = "EMERGENCY_MODE_AUTHORIZATION_APPROVED"
    EMERGENCY_MODE_AUTHORIZATION_REJECTED = "EMERGENCY_MODE_AUTHORIZATION_REJECTED"
