...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("让除草机1去B区进行除草", RuntimeChatIntent.ASSIGN_MOWING_ZONE),
        ...
        ("C区维修好了", RuntimeChatIntent.CLEAR_MAINTENANCE_HAZARD),
        ("C区已处理，可恢复使用", RuntimeChatIntent.CLEAR_MAINTENANCE_HAZARD),
